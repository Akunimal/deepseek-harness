...
import { en as conversationEn, es as conversationEs, NS as CONVERSATION_NS, zh as conversationZh } from '@deepseek-ai/dsh-client-ui-conversation/src/client/locales.ts'
...
async function bench(snapshot: ChatSnapshot) {
  ...
  locale.register(CONVERSATION_NS, { zh: conversationZh, en: conversationEn, es: conversationEs })
